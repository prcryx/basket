...
class alternativeday extends StatefulWidget {
  const alternativeday({Key? key}) : super(key: key);

  @override
  State<alternativeday> createState() => _alternativedayState();
}

class _alternativedayState extends State<alternativeday> {
  @override
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Text('Select Start Date and End date',style: TextStyle(
                    color: Colors.blueAccent,fontWeight: FontWeight.bold // Text color
                )),
              ),
            ),
            Container(child: Image.asset('assets/img_32.png')),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  minimumSize: Size(250, 50), // Set the width to 200 (or your desired width)
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(50),
                  ),
                  primary: Color(0xFF00A3FF), // Button color
                  elevation: 5.0, // Elevation
                ),
                child: Text(
                  'Confirm',
